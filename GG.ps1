...
start "Start-AutopilotOOBE" PowerShell -NoL -C Start-AutopilotOOBE -Title 'GG Autopilot Registration' -Hidden AssignedUser, AssignedComputerName -GroupTag FK -GroupTagOptions GG, POS -AddToGroupOptions 'INTUNE_GG_DEVICE_WINDOWS_ALL_Backoffice' -Assign -PostAction Restart Computer
